...
export default function ContributorLoginChoice() {
  return (
      ...
      <Card className="w-full max-w-md border-0 shadow-xl overflow-hidden bg-white">
        <CardContent className="p-12">
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-[#373131] text-xl leading-relaxed">Fill up a quick form and register as a contributor</p>
          </div>

          <div className="space-y-6">
            <Link href="/register/contributor" className="block">
              <Button
            ...
            <Link href="/signin/contributor" className="block">
              <Button
